...
- Upgrade [kernel_guard](https://crates.io/crates/kernel_guard) dependency to v0.2 and [crate_interface](https://crates.io/crates/crate_interface) dependency to v0.3 (https://github.com/arceos-org/percpu/pull/29).
